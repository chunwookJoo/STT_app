...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        memoList.add(new Memo("hi","hi4",4));
        memoList.add(new Memo("hi","hi5",5));
        memoList.add(new Memo("hi","hi6",6));
        memoList.add(new Memo("hi","hi7",7));
        memoList.add(new Memo("hi","hi8",8));
